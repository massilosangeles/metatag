...
$( document ).ready(function() {
  ...
  $('#form_meta').submit(function(event) {
    ...
    if (captcha_response != '') {
      $.post('metatag_process.php', {title: title, keywords: keywords, description: description, author, author, index: index, follow: follow, mail: mail,newsletter: newsletter, service: service, captcha_response: captcha_response }, function(data) {
      //Write the result
        $('#add').show();
